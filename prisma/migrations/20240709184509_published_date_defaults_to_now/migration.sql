...
INSERT INTO "new_DiscussionThread" ("bookId", "createdAt", "createdById", "id", "publishedDate", "title", "updatedAt") SELECT "bookId", "createdAt", "createdById", "id", "publishedDate", "title", "updatedAt" FROM "DiscussionThread";
